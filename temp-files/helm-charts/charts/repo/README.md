...
| 名称        | 邮箱 | Github ID |
|-----------|------|-----------|
| liuyang | liuyang.com   | liuyanggithub777 |

### Helm chart values说明

| Key | Type | Default | Description |
|-----|------|---------|-------------|
| fullnameOverride | string | `"opengauss-repo"` | 服务名，用于相关资源名称渲染 |
| image.pullPolicy | string | `"IfNotPresent"` | 镜像拉取策略，默认为IfNotPresent |
| image.repository | string | `"swr.cn-north-4.myhuaweicloud.com/opensourceway/opengauss/repo"` | 镜像名称 |
...
| namespace.name | string | `"opengauss-repo"` | 命名空间名称 |
...
| volumes[0].persistentVolumeClaim.claimName | string | `"opengauss-repo"` | pvc名称 |
| pvc.name | string | `"opengauss-repo"` | pvc名称 |
| pvc.accessModes | string | `"ReadWriteMany"` | 访问模式 |
| pvc.size | string | `"10Gi"` | 容量大小 |
